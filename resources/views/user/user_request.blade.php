...
<li class="active"><a href="#">Home</a></li>
        ...
        <br></br>
        <br></br>
       <div class="container text-center"   style="border:10px solid" id="flat">
    <br>
    <br>
    <div class="row">
        <div class="col-md-6">
            ...
            <button type="button" class="btn btn-primary btn-block" id="button" style="width: 80%;" action='/user/request'>Request Asset</button>
                </div>
             
        <div class="col-md-6">
            
          <h2>Status of previous items</h2>
            <table class="table">
             ...
             @if(isset($indents))
                ...
                <td>
<!--                   
                  <div class="row"><span class="glyphicon glyphicon-ok"></span>Approved</div>
                  <div class="row"><span class="glyphicon glyphicon-ok"></span>Approved</div> -->
                </td>
                   <td>
                    {{$i->item}}
                    @if($i->status==0)
                    <div class="row"><span class="glyphicon glyphicon-ok"></span>Registered</div>
                    @else
                    <div class="row"><span class="glyphicon glyphicon-ok"></span>Approved</div>
                    @endif
                  <!-- <div class="row"><span class="glyphicon glyphicon-ok"></span>Approved</div>
